...
public final class InteractEntityTool implements NumenTool {
    ...
    public String description() {
        return "Press a mouse button on an ENTITY — the native interaction for moving targets. Auto-paths "
                ...
                + "reaches it (a wall in the way makes it re-position, not hit through). Set sneak=true "
                + "only when a mod interaction explicitly requires Shift+left/right click; otherwise false.";
    }
    ...
    public void onServerCall(String toolCallId, JsonObject args, NumenPlayer companion, Consumer<String> reply) {
        ...
        runSync(companion, impl.interactEntity(a.button(), a.entity_id(), a.hold_ticks(), a.item_id(), a.sneak(),
